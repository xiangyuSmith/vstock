...
public class LogisticsInformationService {
    ...
    public int save(LogisticsInformation record){
        if (record.getId() != null){
            ...
            logisticsInformation.setTradeId(record.getTradeId());
            logisticsInformation.setStatus("0");
            List<LogisticsInformation> logisticsInformationList = this.findAll(logisticsInformation);
            for (LogisticsInformation logisticsInformations : logisticsInformationList){
                logisticsInformations.setStatus("1");
                this.update(logisticsInformations);
            }
