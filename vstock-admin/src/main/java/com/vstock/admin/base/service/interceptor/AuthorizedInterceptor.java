package com.vstock.admin.base.service.interceptor;
...
public class AuthorizedInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,HttpServletResponse response, Object handler) throws Exception {
        ...
        //设置不拦截的对象
        String[] noFilters = new String[] {"login","saveAdmin","register"};  //对登录本身的页面以及业务不拦截
        ...
        if (beFilter==true) {//除了不拦截的对象以外
            ...
            if (u==null) {//未登录
                response.sendRedirect(basePath + "adminLogin/index");
                return false;
                ...
                if (cokLoginName != null && cokLoginPwd != null && cokLoginName.getValue() != null && cokLoginPwd.getValue() != null) {
                    ...
                    Admin admin = AdminDao.findAdmin(loginName);
                    if (admin == null) {
