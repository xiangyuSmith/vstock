(function(root, factory) {
    ...
    var defaults = {
        ...
        ITEM_CALSS = 'class="Ligang-ul-ol-li"',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_CALSS + '>{wk}</li>',
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}>{value}</li>',
        MONTH_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_CALSS + '  ' + ITEM_MONTH + '>{m}月</li>',
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display Ligang-a">',
            ...
            '<ol class="week Ligang-ul-ol-li">{week}</ol>',
            '<ul class="date-items Ligang-ul-ol-li"></ul>',
            '</div>',
            '</div>',
            '<div class="view view-month">',
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display Ligang-a">{yyyy}</a>',
            '<div class="calendar-arrow">',
            ...
            '</div>',
            '</div>',
            '<ol class="calendar-ct month-items Ligang-ul-ol-li">{month}</ol>',
            '</div>',
            '</div>',
            '</div>',
            '<div class="calendar-label"><p class="Ligang-p">HelloWorld</p><i></i></div>'
        ],
    ...
    Calendar.prototype = {
        ...
        getDaysHtml: function(y, m) {
            var year, month, firstWeek, daysNum, prevM, prevDiff,
                dt = this.date,
                $days = $('<ol class="days Ligang-ul-ol-li"></ol>');
