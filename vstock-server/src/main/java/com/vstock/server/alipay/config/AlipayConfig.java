...
//	public static String now_url = "http://www.v-stock.com";
	...
	public static String notify_trade_url = now_url + "/trade/returnTradePay";

	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	public static String return_url = now_url + "/bid/createPay";

	public static String return_trade_url = now_url + "/trade/createTradePay";
	...
	//支付调用App登录用APPID
	public static final String ALIPAY_APP_ID_LOGIN="2017042406927982";
