...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	public static String notify_url = "http://116.228.89.158:1234/bid/createPay";

	public static String notify_trade_url = "http://116.228.89.158:1234/trade/createTradePay";

	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	public static String return_url = "http://116.228.89.158:1234/bid/createPay";

	public static String return_trade_url = "http://116.228.89.158:1234/trade/createTradePay";
	...
	public static String login_return_url = "http://116.228.89.158:1235/login/alipayLogin";
