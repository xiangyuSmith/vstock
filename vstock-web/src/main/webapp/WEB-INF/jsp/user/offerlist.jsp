                                ...
                                <div class="am-dropdown doc-dropdown-js">
                                    ...
                                    <ul class="am-dropdown-content">
                                        ...
                                        <c:if test="${bid.status == 11}">
                                            ...
                                            <li><a class="am-btn am-btn-xs am-text-left sale-sub" status="0" bid-date="<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd HH:mm:ss" />" href="javascript:void(0)"><i class="am-icon-save am-margin-right-xs"></i><span class="am-text-left am-text-sm">保存</span></a></li>
