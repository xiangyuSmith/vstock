        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-text-xs am-center">
            ...
            <div class="am-u-sm-2 am-u-md-2 am-u-lg-2 am-text-lg am-padding-left-0 am-padding-right-0" style="background-color: #F6F5F4;height: 100%;">
                <ul class="am-nav">
                    ...
                    <li><a href="javascript:void(0)" class="home-tab"><i class="am-icon-rmb am-margin-right-xs am-link-muted"></i><span class="text-color am-text-danger am-link-muted" data-url="../index/testUserInfo" data-type="4">我的资产</span></a></li>
                </ul>
            </div>
