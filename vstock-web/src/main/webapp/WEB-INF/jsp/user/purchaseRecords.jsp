                                    ...
                                    <div class="am-dropdown doc-dropdown-js">
                                        ...
                                        <ul class="am-dropdown-content">
                                            ...
                                            <c:if test="${bid.status == 11}">
                                                <li><a class="am-btn am-btn-xs am-text-left sale-up" data_type="0" href="${cxt}/detail?proName=${bid.bftName}&size=${bid.bftSize}"><div style="float: left; display: block;width: 20px;height: 18px; background: url('/assets/shoesImg/personal_center.png'); background-position: -50px -32px;"></div><span class="am-text-left am-text-sm">重新叫价</span></a></li>
                                            </c:if>
