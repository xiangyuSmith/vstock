                ...
                <div class="am-u-md-12 am-margin-bottom-sm">
                    <div class="am-u-md-6">
                        <div class="am-u-md-6">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-padding-left-0 am-padding-right-0">
                                <span class="layout-font-size-20">最近最高叫价</span>
                            </div>
                            <div class="am-u-md-12">
                        ...
                        <div class="am-u-md-6 am-margin-top-xs">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                                <a href="javascript:;" id="now-buyer-bid" class="am-btn am-btn-success" data-am-modal="{target: '#my-popup-bid', width: 900, height: 520}" style="display: none;">叫价</a>
                                <a href="javascript:;" id="now-seller-bid" class="am-btn am-btn-success" style="display: none;">叫价</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-6" style="border-left: 1px solid #030303">
                        <div class="am-u-sm-6 am-u-md-6 am-u-lg-6">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-padding-left-0 am-padding-right-0">
                                <span class="layout-font-size-20">最近最低叫价</span>
                            </div>
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                                <span class="layout-font-size-20" style="color: #030303">￥
                                    <c:choose>
                        ...
                        <div class="am-u-sm-6 am-u-md-6 am-u-lg-6 am-padding-top-xs">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                                <a href="javascript:;" id="now-buyer-sell" class="am-btn am-btn-danger" style="display: none;">出售</a>
                                <a href="javascript:;" id="now-seller-sell" class="am-btn am-btn-danger" style="display: none;">出售</a>
                            </div>
                        </div>
                    </div>
                </div>
