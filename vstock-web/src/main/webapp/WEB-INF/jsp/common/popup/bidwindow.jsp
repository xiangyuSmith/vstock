...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="my-popup-bid">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-padding-left-0 am-margin-top-sm">
                        <div class="am-u-sm-6 am-u-md-6 am-u-lg-6 am-padding-right-0">
                            <span class="am-fl layout-font-size-18" style="color: #646464;">
                                买家最高出价：
                                <span class="am-margin-left-sm" style="color: #646464;">￥
                                    <c:choose>
                ...
                <div class="am-u-sm-3 am-u-md-3 am-u-lg-3 am-margin-top-xs am-margin-bottom-sm am-text-left">
                    ...
                    <div class="am-u-md-12 am-padding-0 am-margin-bottom-lg">
                        <div class="am-u-md-6 am-padding-0">
                            ...
                            <div>
                                <select id="buyer_sell_size" class="select-pom" placeholder="请选择" data-am-selected="{btnSize: 'xl',btnWidth: 80,  maxHeight: 200}">
                                    <option value=""></option>
                        ...
                        <div class="am-u-md-6 am-padding-0">
                            ...
                            <div style="padding-left: 8px;">
                                <select id="buyer_sell_time" class="am-input-sm am-form-field select-pom" placeholder="请选择" data-am-selected="{btnSize: 'xl',btnWidth: 80,  maxHeight: 200}">
            ...
            <div class="am-u-md-3 am-text-left">
                <div class="am-padding-sm">
                    ...
                    <div class="am-text-center am-margin-top-xl">
                        <a href="javascript:;" id="btn_step_final" class="am-btn am-btn-danger am-btn-lg am-radius  am-btn-block" >提交</a>
                    </div>
                </div>
            </div>
        </div>
